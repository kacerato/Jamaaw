      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Veja como transformamos a infraestrutura de telecomunicações de Maceió
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="absolute bottom-4 left-4 text-white">
                <h3 className="text-lg font-semibold">Equipe em Campo</h3>
                <p className="text-sm opacity-90">Organizando cabos em Maceió</p>
              </div>
            </div>

            <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl p-8 flex items-center justify-center text-center">
              <div>
                <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Cable className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-blue-900 mb-2">Antes & Depois</h3>
                <p className="text-blue-700">Transformação completa da organização dos cabos</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-100 to-orange-200 rounded-2xl p-8 flex items-center justify-center text-center">
              <div>
                ...
                <h3 className="text-xl font-bold text-orange-900 mb-2">Resultado Final</h3>
                <p className="text-orange-700">Organização profissional e durável</p>
              </div>
            </div>
          </div>
        </div>
