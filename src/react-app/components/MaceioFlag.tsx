...
export default function MaceioFlag() {
  ...
  return (
    <div className="relative">
      <div 
        className="w-16 h-12 bg-gradient-to-b from-[#3b82f6] to-[#2563eb] rounded shadow-lg cursor-pointer hover:shadow-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden"
        onClick={() => setShowInfo(!showInfo)}
      >
        {/* Flag design representing Maceió */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#3b82f6] via-white to-[#22c55e]">
          {/* Blue top section */}
      ...
      {showInfo && (
        <div className="absolute bottom-14 left-0 bg-white rounded-lg shadow-xl p-4 w-64 z-50 border border-slate-200">
          <div className="flex items-center space-x-2 mb-2">
            <div className="w-8 h-6 bg-gradient-to-b from-[#3b82f6] via-white to-[#22c55e] rounded border"></div>
          ...
          <button
            ...
            className="mt-2 text-xs text-[#2563eb] hover:text-[#1d4ed8]"
          >
            Fechar
          </button>
        </div>
